...
@php
    ...
    $__spmJsMessages = json_encode([
        ...
        'paypalComingSoon'   => __('payment.paypal_coming_soon'),
    ...
    <div class="spm-panel" role="document">
        ...
        <div class="spm-body">
            ...
            <form id="spm-form" class="spm-form" novalidate>
                ...
                {{-- PayPal smoke-test button — visually identical to the
                     official Stripe-rendered PayPal button. Click logs
                     'paypal_attempted' to activity log + GA4 dataLayer
                     for daily ratio analysis, shows a coming-soon alert,
                     scrolls to the card form. NO real PayPal flow yet. --}}
                <button type="button" id="spm-paypal-btn" class="spm-paypal-btn" aria-label="PayPal">
                    <svg viewBox="0 0 124 33" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
...
<style>
    ...
    /* ── PayPal smoke-test button (visually identical to Stripe-rendered
          PayPal button — same #FFC439 base, same 8px radius, same height
          as Apple Pay / Link buttons that Payment Element renders) ── */
    .spm-paypal-btn {
        width: 100%;
        height: 44px;
        background: #FFC439;
        ...
        justify-content: center;
        margin-bottom: 4px;
        transition: background-color 150ms ease-out, transform 160ms cubic-bezier(0.23, 1, 0.32, 1);
    }
    .spm-paypal-btn:hover { background: #f5b929; }
    .spm-paypal-btn:active { background: #e5a929; transform: scale(0.99); }
    .spm-paypal-btn:focus-visible {
