                    ...
                    <div class="flex items-start gap-4 mb-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-slate-700 mt-2 font-medium">
                                {{ __('dashboard.next_payment_amount', ['date' => $subscription->current_period_end->format(__('dashboard.date_format_short'))]) }}<span class="text-brand-600">{{ $pricing['symbol'] ?? '€' }}{{ number_format($pricing['subscription'] ?? 39.90, 2, app()->getLocale() === 'en' ? '.' : ',', '') }}</span>
                            </p>
                        </div>
                    </div>
